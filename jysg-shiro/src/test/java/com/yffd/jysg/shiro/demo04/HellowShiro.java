...
public class HellowShiro {
    private static final String SHIR_CFG_FILE_PATH = "classpath:demo02/shiro-realm.ini";
...
//        Assert.assertEquals(true, subject.isAuthenticated()); //断言用户已经登录
    ...
    public void testStrategy() {
        ...
        String password = "123";
        //1、获取SecurityManager工厂，此处使用Ini配置文件初始化SecurityManager
        Factory<SecurityManager> factory = new IniSecurityManagerFactory("classpath:demo04/shiro-authenticator-all-success.ini");
