...
<h1>当前为客户端1</h1>
<h2><a href="http://app1.cas.com:8081/index.jsp">客户端1</a></h2>
<h2><a href="http://app2.cas.com:8082/index.jsp">客户端2</a></h2>

<h3><a href="<%=request.getContextPath() %>/cas/logout1" title="Click here to log out">退出系统（方式1:跳转到默认页）</a></h3>
<h3><a href="<%=request.getContextPath() %>/cas/logout2" title="Click here to log out">退出系统（方式2:跳转到指定页）</a></h3>
