 ...
 * @Date		 2018年7月18日 下午4:24:39 <br/>
 * @author       zhangST
 * @version		 1.0
 * @since		 JDK 1.7+
 * @see 	 
 */
public class CandidateUsers2TaskTest {
	...
	public void deployProcessDefinitionByClasspathTest() {
		...
		InputStream inputStreamBpmn = this.getClass().getResourceAsStream("candidateUsers2.bpmn");
		InputStream inputStreamPng = this.getClass().getResourceAsStream("candidateUsers2.png");
		Deployment deployment = processEngine.getRepositoryService()
					.createDeployment()
					.name(name )
					.category(category)
					.addInputStream("candidateUsers2.bpmn", inputStreamBpmn)//
					.addInputStream("candidateUsers2.png", inputStreamPng)//
					.deploy();
	...
	public void startProcessInstanceTest() {
		String processDefinitionKey = "candidateUsers2";
