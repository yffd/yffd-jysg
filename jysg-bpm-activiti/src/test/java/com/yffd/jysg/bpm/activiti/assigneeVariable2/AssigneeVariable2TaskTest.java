 ...
 * @Date		 2018年7月18日 上午10:56:11 <br/>
 * @author       zhangST
 * @version		 1.0
 * @since		 JDK 1.7+
 * @see 	 
 */
public class AssigneeVariable2TaskTest {
	ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
	
	/** 部署流程定义（从classpath） */
	@Test
	public void deployProcessDefinitionByClasspathTest() {
		String name = "流程代理人变量2(监听器)";
		String category = "test";
		InputStream inputStreamBpmn = this.getClass().getResourceAsStream("assigneeVariable2.bpmn");
		InputStream inputStreamPng = this.getClass().getResourceAsStream("assigneeVariable2.png");
		Deployment deployment = processEngine.getRepositoryService()
					.createDeployment()
					.name(name )
					.category(category)
					.addInputStream("assigneeVariable2.bpmn", inputStreamBpmn)//
					.addInputStream("assigneeVariable2.png", inputStreamPng)//
					.deploy();
	...
	public void startProcessInstanceTest() {
		String processDefinitionKey = "assigneeVariable2";
