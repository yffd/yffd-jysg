package com.yffd.jysg.bpm.activiti.candidateGroups;
 ...
 * @Date		 2018年7月18日 下午4:37:18 <br/>
 * @author       zhangST
 * @version		 1.0
 * @since		 JDK 1.7+
 * @see 	 
 */
public class CandidateGroupsTaskTest {
	...
	public void deployProcessDefinitionByClasspathTest() {
		...
		InputStream inputStreamBpmn = this.getClass().getResourceAsStream("candidateGroups.bpmn");
		InputStream inputStreamPng = this.getClass().getResourceAsStream("candidateGroups.png");
		Deployment deployment = processEngine.getRepositoryService()
					.createDeployment()
					.name(name )
					.category(category)
					.addInputStream("candidateGroups.bpmn", inputStreamBpmn)
					.addInputStream("candidateGroups.png", inputStreamPng)
					.deploy();
	...
	public void startProcessInstanceTest() {
		String processDefinitionKey = "candidateGroups";
	...
	/** 查询当前人的组任务 */
	@Test
	public void findMyGroupTaskTest() {
	...
	/** 查询正在执行的任务办理人表 */
	@Test
	public void findRunPersonTaskTest() {
		//任务ID
		String taskId = "222504";
	...
	/** 查询历史任务的办理人表 */
	@Test
	public void findHistoryPersonTaskTest() {
		//流程实例ID
		String processInstanceId = "222504";
	...
	public void claimTest() {
		...
		System.out.println("任务拾取完成：" + taskId);
	}
	
	/** 将个人任务回退到组任务，前提，之前一定是个组任务 */
	@Test
	public void setAssigeeTest() {
		//任务ID
